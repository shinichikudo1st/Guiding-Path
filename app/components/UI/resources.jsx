...
const ResourceFeed = () => {
  ...
  return (
    <div className="resourceContainer absolute bg-[#dfecf6] 2xl:w-[55%] 2xl:h-[80%] 2xl:translate-x-[41%] 2xl:translate-y-[20%] rounded-[20px] flex flex-col items-center pt-[3%] gap-[5%] overflow-y-auto">
      ...
      <div className="w-full px-[5%] flex flex-col gap-6">
        {resources.map((resource, index) => (
          <div
            ...
            className="bg-white p-6 rounded-xl shadow-lg w-full mb-6 transition-all duration-300 hover:shadow-xl"
          >
      ...
      {!loading && !hasMore && (
        <p className="text-gray-600 italic mb-4">No more resources to load.</p>
      )}
      {!loading && hasMore && (
        <button
