  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Form */}
        <form onSubmit={uploadImage} className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <motion.div whileHover={{ scale: 1.01 }} className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-white rounded-xl border border-[#0B6EC9]/10 focus:border-[#0B6EC9]/30 focus:ring-2 focus:ring-[#0B6EC9]/10 outline-none transition-all duration-300 shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#0B6EC9]/10 file:text-[#0B6EC9] hover:file:bg-[#0B6EC9]/20"
              />
            </motion.div>
            <p className="text-xs text-[#062341]/50 mt-2">
