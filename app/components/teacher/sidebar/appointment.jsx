  ...
  return (
    <>
      <div className="absolute bg-[#dfecf6] 2xl:w-[55%] 2xl:h-[80%] 2xl:translate-x-[41%] 2xl:translate-y-[20%] rounded-[20px] flex flex-col items-center px-[4%] pt-[3%] gap-[5%]">
        <h2 className="text-3xl font-bold text-[#062341] mb-6">Appointments</h2>
        <div className="w-full h-[80%] bg-gradient-to-br from-[#F0F8FF] to-[#E6F0F9] rounded-lg shadow-2xl overflow-auto p-6 flex flex-col">
          {loading ? (
                ...
                >
                  <div className="flex items-center w-full">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-xs font-medium mt-1 bg-blue-100 text-blue-700 px-2 py-1 rounded-full">
                        Student
                      </p>
                    </div>
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-xs font-medium mt-1 bg-green-100 text-green-700 px-2 py-1 rounded-full">
                        Counselor
                      </p>
                    </div>
                    <div className="flex-grow-0 mx-4 border-dotted border-r-2 border-gray-300 h-16"></div>
