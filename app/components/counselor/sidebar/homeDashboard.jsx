...
const CounselorHome = () => {
  ...
  return (
    <>
      ...
      <div className="absolute bg-[#dfecf6] 2xl:w-[55%] 2xl:h-[80%] 2xl:translate-x-[41%] xl:translate-y-[20%] 2xl:translate-y-[16%] rounded-[20px] flex flex-col items-center px-[4%] pt-[1%] gap-[5%]">
